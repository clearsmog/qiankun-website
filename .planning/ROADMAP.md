...
- [ ] 03-01-PLAN.md — Tracer: create `tokens.js`, wire the PWA manifest through it, convert one chart component's theme trigger, and browser-prove the post-flush recipe before scaling (wave 1)
...
| 3. Design Token Consolidation | 0/3 | Planned | - |
